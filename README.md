...
●	To detect toxic comments and identify potential toxic user in social media.
●	To delete the toxic comment determining the level of toxicity of the comment.
